<?php /* Smarty version Smarty-3.1.7, created on 2015-05-26 12:00:05
         compiled from "C:\Program Files (x86)\vtigerCRM620\apache\htdocs\vtigerCRM\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8102555f8affcbc8d8-03564515%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3614a3577f806ff2830825d32417d7c0e075315c' => 
    array (
      0 => 'C:\\Program Files (x86)\\vtigerCRM620\\apache\\htdocs\\vtigerCRM\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsDetail.tpl',
      1 => 1432641604,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8102555f8affcbc8d8-03564515',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_555f8afff1d53',
  'variables' => 
  array (
    'RELATED_PRODUCTS' => 0,
    'MODULE_NAME' => 0,
...
<?php if ($_valid && !is_callable('content_555f8afff1d53')) {function content_555f8afff1d53($_smarty_tpl) {?>
...
'><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
            ...
            <?php  $_smarty_tpl->tpl_vars['tax_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_details']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["taxes"]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['tax_details']->key => $_smarty_tpl->tpl_vars['tax_details']->value){
$_smarty_tpl->tpl_vars['tax_details']->_loop = true;
?>
                <?php if ($_smarty_tpl->tpl_vars['tax_details']->value["percentage"]>0){?>
                    <?php echo $_smarty_tpl->tpl_vars['tax_details']->value["taxlabel"];?>
 (<?php echo $_smarty_tpl->tpl_vars['tax_details']->value["percentage"];?>
 %) = <?php echo $_smarty_tpl->tpl_vars['tax_details']->value["amount"];?>
