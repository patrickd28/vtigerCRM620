<?php /* Smarty version Smarty-3.1.7, created on 2015-05-22 19:56:19
         compiled from "C:\Program Files (x86)\vtigerCRM620\apache\htdocs\vtigerCRM\includes\runtime/../../layouts/vlayout\modules\Products\PriceBookProductPopupContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2216555f89e33f96d6-01376349%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99da8d1ef394a88861e52b23939f778c19f3ca5f' => 
    array (
      0 => 'C:\\Program Files (x86)\\vtigerCRM620\\apache\\htdocs\\vtigerCRM\\includes\\runtime/../../layouts/vlayout\\modules\\Products\\PriceBookProductPopupContents.tpl',
      1 => 1407848816,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2216555f89e33f96d6-01376349',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_555f89e34d5e7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555f89e34d5e7')) {function content_555f89e34d5e7($_smarty_tpl) {?>
...
" name="listPrice" class="invisible span10 zeroPaddingAndMargin" data-validation-engine="validate[required,funcCall[Vtiger_Currency_Validator_Js.invokeValidation]]"data-decimal-seperator='<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('currency_decimal_separator');?>
' data-group-seperator='<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('currency_grouping_separator');?>
'/></div></td></tr><?php } ?></table></div><!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><div class="row-fluid"><div class="emptyRecordsDiv"><?php echo vtranslate('LBL_NO',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
